...
func main() {
	...
	go slave.Slave(*id, online, goOnlineCalls, masterToSlaveOfflineCh, slaveToMasterOfflineCh)
	go backup.Backup(*id, online, goOnlineCalls, masterToSlaveOfflineCh, slaveToMasterOfflineCh)
